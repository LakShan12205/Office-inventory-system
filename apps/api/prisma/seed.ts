...
const assetTypeDefinitions = [
  ...
  { code: "ADP", name: "Adapter", description: "Power adapter", trackIndividually: true },
  { code: "SIM", name: "SIM", description: "SIM card", trackIndividually: true },
  { code: "CHR", name: "Chair", description: "Workstation chair", trackIndividually: true },
  { code: "TBL", name: "Table", description: "Workstation table", trackIndividually: true },
